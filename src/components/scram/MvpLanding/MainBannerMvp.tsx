          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="repair-banner-content">
                <h1>Software Factory, IA, MVP para Empresas y Startups</h1>
                <p>
                <strong> Soluciones exclusivas para empresas desde 1997: </strong> Creación de MVP, Prototipos, Cloud, Arquitectura de Software a escala mundial, Soluciones con Inteligencia Artificial, Desarrollo de Apps y Plataformas Web para satisfacer las demandas de las empresas en todo el mundo, pero principalmente en México y Estados Unidos.
