          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="repair-banner-content">
                <h1>Stock de +15.000 Piezas de Tecnología y Equipos Industriales</h1>
                <p>
                <strong>Somos Proveedores desde 1997: </strong>  Partes de servidores y 
                Equipos industriales, fuentes de poder, sensores, energía, 
