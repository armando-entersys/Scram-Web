          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="repair-banner-content">
                <h1>Marketing enfocado en Publicidad (ADS) Especializado en Centros Médicos y Estéticos</h1>
                <p>
                <strong>(Desde 1997) Sistema efectivo de Adquisición de Pacientes: </strong> 
                No solo gestionamos campañas publicitarias ADS, hemos diseñado un ecosistema de marketing digital que atrae pacientes que buscan atención de un nivel acorde a tu clínica o centro estético. <strong>El resultado:</strong> Una máquina imparable de generación de citas. 
