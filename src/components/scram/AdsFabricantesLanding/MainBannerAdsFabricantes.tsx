          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="repair-banner-content">
                <h1>Marketing enfocado en Publicidad (ADS) para Fabricantes de Muebles en General</h1>
                <p>
                <strong>(Desde 1997) Sistema efectivo de Adquisición de Clientes Mayoristas y Minoristas: </strong> 
                No solo gestionamos campañas publicitarias ADS, hemos creado un ecosistema de marketing digital diseñado para atraer clientes mayoristas y minoristas de manera eficiente y con un alto retorno de inversión. <strong>El resultado:</strong> Una máquina imparable de generación de leads y ventas. 
                ...
                <ButtonWhatsapp 
                  ...
                  p="w" nu="529993882606" 
                  href="?click=whatsappAdsFabricantes"
